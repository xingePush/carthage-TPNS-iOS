    ...
    switch (indexPath.section) {
        ...
        case 2:
        {
            ...
            if (indexPath.row == 0) {
                ...
                [[XGPush defaultManager] startXGWithAppID:kAppID appKey:kAppKey delegate:(id<XGPushDelegate>)appDelegate];
    ...
    if (buttonIndex == 1) {
        if ([alertView.title isEqualToString:inputAccountTitle]) {
            if (self.operationType == Add) {
                ...
                [[XGPushTokenManager defaultTokenManager] updateBindedIdentifiers:@[@{@"account":identifier, @"accountType":@(0)}] bindType:XGPushTokenBindTypeAccount];
            }
